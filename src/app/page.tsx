    ...
    <>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6">
          <h1 className="text-5xl sm:text-6xl md:text-8xl font-[var(--font-script)] text-white leading-tight">
            cocoelif
          </h1>
        </div>
      ...
      <section className="py-24 md:py-32 bg-[var(--background-warm)]">
        <div className="container max-w-3xl">
          ...
          <div className="text-center mt-16">
            <Link
              href="/blog"
              className="inline-flex items-center gap-2 font-[var(--font-script)] text-2xl text-[var(--foreground)] hover:text-[var(--accent-gold)] transition-colors"
            >
